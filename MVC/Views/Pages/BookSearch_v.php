...
<body>
    <form class="row g-3" method="post" action="http://localhost/Library/BookSearch/Searching">
        <div class="col-md-3">
    ...
    <table style="border-collapse:collapse;border: 1px solid black" class="table table-hover">
        <thead>
            <tr class="table-primary" style="text-align:center">
                ...
                <th style="width: 10vw;border: 1px solid black">Số lượng</th>
            </tr>    
        </thead>
        <tbody>
               <?php    
               ...
               ?>
                    <tr >
                        ...
                        <td style="width: 10vw;border: 1px solid black"><?php echo $row['soLuong'] ?></td>
                    </tr>
               <?php
                    }
                }
