...
<body>
    ...
    <form class="row g-3" method="post" action="http://localhost/Library/Tracuumuontra/Timkiem">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="form-floating mb-3">
                <input name="txtMaSV" type="text" class="form-control" id="floatingInput2" value="<?php if(isset($data['masv'])) echo $data['masv']?>">
                <label for="floatingInput2">Mã sinh viên</label>
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-floating mb-3">
    ...
    <table style="border-collapse:collapse;border: 1px solid black" class="table table-hover">
        <thead>
            <tr class="table-primary" style="text-align:center">
                ...
                <th style="width: 20vw;border: 1px solid black">Mã sách</th>
                <th style="width: 20vw;border: 1px solid black">Mã sinh viên</th>
                <th style="width: 20vw;border: 1px solid black">Ngày mượn</th>
        ...
        <tbody>
               ...
               ?>
                    <tr >
                        ...
                        <td style="width: 20vw;border: 1px solid black"><?php echo $row['maSach'] ?></td>
                        <td style="width: 20vw;border: 1px solid black"><?php echo $row['maSV'] ?></td>
                        <td style="width: 20vw;border: 1px solid black"><?php echo $row['FngayMuon'] ?></td>
                        <td style="width: 10vw;border: 1px solid black">
                            <a href="http://localhost/Library/Tracuumuontra/Chitiet/<?php echo $row['maMuon'] ?>">
                                Chi tiết
                            </a>
                        </td>
                    </tr>
